Name:           ros-kinetic-qb-move
Version:        1.0.5
Release:        0%{?dist}
Summary:        ROS qb_move package

Group:          Development/Libraries
License:        BSD 3-Clause
URL:            http://wiki.ros.org/qb_move
Source0:        %{name}-%{version}.tar.gz

BuildArch:      noarch

Requires:       ros-kinetic-qb-move-control
Requires:       ros-kinetic-qb-move-description
