Name:           ros-kinetic-qb-move-control
Version:        1.0.4
Release:        0%{?dist}
Summary:        ROS qb_move_control package

Group:          Development/Libraries
License:        BSD 3-Clause
URL:            http://wiki.ros.org/qb_move_control
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-kinetic-qb-device-control
Requires:       ros-kinetic-qb-move-hardware-interface
Requires:       ros-kinetic-roscpp
BuildRequires:  ros-kinetic-catkin
BuildRequires:  ros-kinetic-qb-device-control
BuildRequires:  ros-kinetic-qb-move-hardware-interface
